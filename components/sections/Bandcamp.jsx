...
// "Buy my music" marquee — an auto-sliding strip of Bandcamp players,
// bleeding past the page margins. One album repeated for now; swap in the
// full discography's embed URLs later.
const EMBED_SRC =
  "https://bandcamp.com/EmbeddedPlayer/album=3260472955/size=large/bgcol=ffffff/linkcol=333333/minimal=true/transparent=true/";

const TILES_PER_STRIP = 5;
